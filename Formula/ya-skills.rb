class YaSkills < Formula
  ...
  url "https://github.com/Yaphet2015/ya-skills/releases/download/v0.25.1/ya-skills-v0.25.1-macos-arm64.tar.gz"
  sha256 "f694d2867bc7d63392a761c455fd53e34593393cff6864f973652146ee4993fe"
  ...
  test do
    assert_match "0.25.1", shell_output("#{bin}/yk --version")
