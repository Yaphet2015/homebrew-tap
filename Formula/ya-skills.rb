class YaSkills < Formula
  ...
  url "https://github.com/Yaphet2015/ya-skills/releases/download/v0.22.0/ya-skills-v0.22.0-macos-arm64.tar.gz"
  sha256 "df55c588e1c3e59ba36f795c8334f6fd9c3772076b6b66ebba86a5830113214c"
  ...
  test do
    assert_match "0.22.0", shell_output("#{bin}/yk --version")
