class YaSkills < Formula
  ...
  url "https://github.com/Yaphet2015/ya-skills/releases/download/v0.15.0/ya-skills-v0.15.0-macos-arm64.tar.gz"
  sha256 "e064771fc7ba2191bda79a52dd2ae9727ce46c9863ec0438a5a241077b2196e1"
  ...
  test do
    assert_match "0.15.0", shell_output("#{bin}/yk --version")
